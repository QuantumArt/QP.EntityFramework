...
namespace EntityFramework6.Data.AspNetCore
{
    public partial class MarketingProduct: IQPArticle
    {
        ...
        protected static readonly Dictionary<string, Func<MarketingProduct, IQPFormService, string>> _valueExtractors = new Dictionary<string, Func<MarketingProduct,  IQPFormService, string>>
        {
			...
			{ "CommentForFamily", new Func<MarketingProduct, IQPFormService, string>((self, ctx) => self.CommentForFamily != null ? ctx.ReplacePlaceholders(self.CommentForFamily) : null) },
    ...
    public partial class Product: IQPArticle
    {
        ...
        protected static readonly Dictionary<string, Func<Product, IQPFormService, string>> _valueExtractors = new Dictionary<string, Func<Product,  IQPFormService, string>>
        {
			...
			{ "Legal", new Func<Product, IQPFormService, string>((self, ctx) => self.Legal != null ? ctx.ReplacePlaceholders(self.Legal) : null) },
			{ "Benefit", new Func<Product, IQPFormService, string>((self, ctx) => self.Benefit != null ? ctx.ReplacePlaceholders(self.Benefit) : null) },
    ...
    public partial class ProductParameter: IQPArticle
    {
        ...
        {
			{ "Title", new Func<ProductParameter, IQPFormService, string>((self, ctx) => self.Title != null ? ctx.ReplacePlaceholders(self.Title) : null) },
			...
			{ "ShortTitle", new Func<ProductParameter, IQPFormService, string>((self, ctx) => self.ShortTitle != null ? ctx.ReplacePlaceholders(self.ShortTitle) : null) },
        ...
        void IQPArticle.OnMaterialized(IQPLibraryService context)
        {
			...
			this.Legal = context.ReplacePlaceholders(this.Legal);
			this.ShortTitle = context.ReplacePlaceholders(this.ShortTitle);
