    ...
    public partial class EF6Model: IQPLibraryService, IQPFormService, IQPSchema
    {
		...
		public static string DefaultConnectionString
		{
			get
			{
				...
				{
					var obj = ConfigurationManager.ConnectionStrings[_defaultConnectionStringName];
					if (obj == null)
        ...
        {
            CurrentObjectContext.ObjectMaterialized += OnObjectMaterialized;
        }
      ...
      private void UpdateObjectStateEntries(IEnumerable<ObjectStateEntry> entries, Func<ContentInfo, ObjectStateEntry, string[]> getProperties, bool passNullValues)
        {
            ...
            var relations = (from e in entries
                    ...
                    {
                        Id = id,
                        RelatedId = relatedId, attribute.ContentId,
        ...
        private static void ProcessCreating(string contentName, IQPArticle instance, ObjectStateEntry entry)
        {
            throw new NotImplementedException();
        }

        private static void ProcessUpdating(string contentName, IQPArticle instance, ObjectStateEntry entry)
        {
		    throw new NotImplementedException();
        ...
        {
            return Cnn.GetFormNameByNetNames(SiteId, netContentName, netFieldName);
        }
